import { EMPTY_ADDRESS, MAX_PLANET_LEVEL } from "@df/constants";
import { isLocatable } from "@df/gamelogic";
import { bonusFromHex } from "@df/hexgen";
import { getPlanetName } from "@df/procedural";
import { type Planet, PlanetType, TooltipName } from "@df/types";
        ...
        <>
          ...
          {planet.capturer !== EMPTY_ADDRESS && (
            <TooltipTrigger
              ...
              extraContent={
                <>This planet has been captured by {planet.capturer}</>
              }
            >
              <Icon type={IconType.Capturable} />
            </TooltipTrigger>
    ...
    <StyledPlanetIcons>
      ...
      {(planet.destroyed || planet.frozen) && (
        <TooltipTrigger
          ...
          extraContent={
            <>
              This planet is destroyed/frozen. It does not generate energy or
              silver, all incoming voyages are void, and you cannot send or
              receive energy from it.
            </>
          }
        >
