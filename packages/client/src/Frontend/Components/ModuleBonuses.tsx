...
interface ModuleBonusesProps {
  artifact: Artifact;
}

export function ModuleBonuses({ artifact }: ModuleBonusesProps) {
  ...
  const bonuses = [
    {
      ...
      label: "Attack",
      value: moduleData.attackBonus || 0,
    },
    {
      icon: IconType.Defense,
      tooltip: TooltipName.Defense,
      label: "Defense",
      value: moduleData.defenseBonus || 0,
    },
    {
      icon: IconType.Speed,
      tooltip: TooltipName.Speed,
      label: "Speed",
      value: moduleData.speedBonus || 0,
    },
    {
      icon: IconType.Range,
      tooltip: TooltipName.Range,
      label: "Range",
      value: moduleData.rangeBonus || 0,
    },
  ];

  return (
    <BonusesContainer>
      <Green>Module Bonuses</Green>
