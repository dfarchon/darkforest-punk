...
import { engineConsts } from "@df/renderer";
  ...
  return (
    <div>
      ...
      <p>
        ...
        each column&apos;s header. You can also navigate to a planet that you
        own by clicking on its name. The planet you click will be centered at
        the spot on the screen where the current planet you have selected is
        located.
      </p>
    </div>
  );
